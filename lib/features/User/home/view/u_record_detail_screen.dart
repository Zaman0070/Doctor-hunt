...
class UserRecordDetailScreen extends StatefulWidget {
  const UserRecordDetailScreen({super.key, required this.model});
  final MedRecordModel model;

  @override
  State<UserRecordDetailScreen> createState() => _UserRecordDetailScreenState();
}

class _UserRecordDetailScreenState extends State<UserRecordDetailScreen> {
