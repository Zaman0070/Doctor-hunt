...
class PEditProfileScreen extends ConsumerStatefulWidget {
  final UserModel userModel;
  final PharmacyInfoModel pharmacyInfoModel;
  const PEditProfileScreen({
    Key? key,
  ...
  @override
  ConsumerState<PEditProfileScreen> createState() => _EditProfileScreenState();
}

class _EditProfileScreenState extends ConsumerState<PEditProfileScreen> {
                            ...
                            Expanded(
                              child: InkWell(
                                ...
                                child: Container(
                                  ...
                                  child: Center(
                                    child: Text(
                                      ctr.timeStr != '' ? ctr.timeStr : 'From',
                                      style: getLightStyle(
                                          color: MyColors.darkContainerColor,
                                          fontSize: MyFonts.size12),
                                    ),
                                  ),
                                ),
                      ...
                      return CustomButton(
                        ...
                        onPressed: () async {
                          ...
                          PharmacyInfoModel pharmacyInfoModel =
                            ...
                            'pharmacyCreatedAt': DateTime.now().toString(),
                            'pharmacyId':
