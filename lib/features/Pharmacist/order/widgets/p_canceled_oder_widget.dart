...
class PCanncelledOrderWidget extends ConsumerWidget {
  const PCanncelledOrderWidget({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Consumer(builder: (context, ref, child) {
      final orderStream = ref.watch(watchOrderByStatus('Cancelled'));
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: MyColors.red.withOpacity(0.15),
                                  ),
                                  child: Center(
                                    child: Text(
                                      model.orderStatus!,
