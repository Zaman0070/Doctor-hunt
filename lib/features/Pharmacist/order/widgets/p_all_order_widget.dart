...
class PAllOrderWidget extends ConsumerWidget {
  const PAllOrderWidget({super.key});

  @override
  Widget build(BuildContext context, WidgetRef ref) {
    return Consumer(builder: (context, ref, child) {
      final orderStream = ref.watch(
          watchAllOrderByIdProvider(FirebaseAuth.instance.currentUser!.uid));
                              ...
                              children: [
                                ...
                                Container(
                                  ...
                                  decoration: BoxDecoration(
                                    ...
                                    color: model.orderStatus == "Cancelled"
