...
class DoctorChangePasswordProfileScreen extends StatefulWidget {
  const DoctorChangePasswordProfileScreen({Key? key}) : super(key: key);

  @override
  State<DoctorChangePasswordProfileScreen> createState() =>
      _DoctorChangePasswordProfileScreenState();
}

class _DoctorChangePasswordProfileScreenState
    extends State<DoctorChangePasswordProfileScreen> {
