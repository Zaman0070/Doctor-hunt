...
class DRecordCard extends StatefulWidget {
  const DRecordCard({
    Key? key,
    required this.model,
  }) : super(key: key);
  ...
  @override
  State<DRecordCard> createState() => _DRecordCardState();
}

class _DRecordCardState extends State<DRecordCard> {
        ...
        child: Row(
          children: [
            ...
            Column(
              ...
              children: [
                Text(
                  'Records added by ${widget.model.userName}',
                  style: getMediumStyle(
